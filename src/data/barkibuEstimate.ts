...
const TEST_COSTS: Record<string, number> = {
  ...
  'vet-tt4': 58,
  'vet-sdma-upc': 72,
  'vet-pancreatic-lipase': 68,
  'vet-ntprobnp': 95,
  'vet-fecal': 38,
  'vet-parvo-snap': 42,
  'vet-fluorescein-stain': 22,
  'vet-tonometry': 32,
...
const TREATMENT_COSTS: Record<string, number> = {
  ...
  'vet-antiemetic': 38,
  'vet-analgesia': 42,
  'vet-bronchodilator': 48,
  'vet-eye-medication': 36,
  'vet-urinary-catheter': 180,
  'vet-decontamination': 95,
  'vet-protective-collar': 18,
  'vet-activity-restriction': 20,
  'vet-surgery-referral': 55,
  'vet-diet-plan': 32,
  'vet-bp-management': 42,
  'vet-hospitalize': 260,
  'vet-discharge': 25,
  'vet-recheck': 35,
};
...
const MEDICATION_COSTS: Record<string, { flat?: number; perKg?: number; dispensing?: number }> = {
  ...
  methimazole: { flat: 24 },
  'renal-diet-plan': { flat: 38 },
  amlodipine: { flat: 18 },
  'carprofen-vet': { perKg: 0.95, dispensing: 12 },
  'prednisolone-vet': { flat: 16 },
  'albuterol-inhaler': { flat: 62 },
  'ofloxacin-eye-drops': { flat: 28 },
};
