...
export const MEDICATIONS: Medication[] = [
  {
    ...
    indications: ['canine-parvoviral-enteritis', 'acute-gastroenteritis', 'theobromine-toxicosis'],
  },
  {
  ...
  },
  {
    ...
    indications: ['feline-urethral-obstruction', 'acute-gastroenteritis'],
  },
  {
    id: 'prazosin',
    name: 'Prazosin',
...
export const SPECIALTY_MEDICATION_CATEGORIES: Record<ClinicId, MedicationCategory[]> = {
  ...
  cardiology: ['cardiovascular', 'analgesic'],
  ...
  pulmonology: ['cardiovascular', 'antibiotic', 'emergency'],
  nephrology: ['urology', 'analgesic', 'emergency'],
